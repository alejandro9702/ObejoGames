...
public class ShapesAdapter extends ArrayAdapter<MyShape> {
    private int layoutResource;
    private Context context;

    public ShapesAdapter(Context context, int layoutResource, List<MyShape> myShape) {
    ...
    public View getView(int position, View convertView, ViewGroup parent ) {
        ...
        if (myShape !=null ) {
            ...
            TextView tvwDescription = (TextView) convertView.findViewById(R.id.tvwDescription);
            ImageView imgShape = (ImageView) convertView.findViewById(R.id.imgShape);
